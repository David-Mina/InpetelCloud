...
<!--MODAL EVENTOS CONCENTRADOR-->
<div class="modal fade" id="modalEventosConcentrador" tabindex="-1" role="dialog" aria-labelledby="modalEventosConcentrador" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabelMdm">Eventos concentrador</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
